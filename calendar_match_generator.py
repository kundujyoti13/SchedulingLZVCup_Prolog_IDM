...
def process_instance_files(program_file, instance_files, timeout):
    for instance_file in instance_files:
        output_folder = "output_calendar"
        os.makedirs(output_folder, exist_ok=True)
        file_name = "output"+instance_file[17:-3]+".txt"
...
instance_files = glob.glob("calanderInstance\*.lp")  # Assuming the instance files are in the "instances" directory
program_file = "unschedule.lp"  # Path to the Clingo program file
